...
public class GenericApplicationContext extends AbstractApplicationContext implements BeanDefinitionRegistry {
	...
	public GenericApplicationContext() {
		//任何ApplicationContext都是一个BeanFactory,也可以理解为内部持有了一个BeanFactory,只不过ApplicationContext更为强大,不仅包括了BeanFactory的所有功能,还有其他功能
		//例如MessageSource表示国际化，ApplicationEventPublisher表示事件发布，EnvironmentCapable表示获取环境变量，等等

		//而这里创建一个DefaultListableBeanFactory
		//DefaultListableBeanFactory非常强大,因为实现了很多接口,所以支持很多功能
